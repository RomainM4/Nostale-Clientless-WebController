...
namespace SuperSimpleTcp
{
    ...
    public class SimpleTcpClient : IDisposable
    {
        ...
        /// <summary>
        /// SimpleTcp client proxy settings.
        /// </summary>
        public SimpleTcpClientProxySettings ProxySettings
        {
            get
            {
                return _proxy;
            ...
            set
            {
                if (value == null) _proxy = new SimpleTcpClientProxySettings();
                else _proxy = value;
            }
        }
        ...
        private SimpleTcpClientProxySettings _proxy = new SimpleTcpClientProxySettings();
        ...
        public void Connect()
        {
            ...
            {
                Socks5ProxyClient proxyClient = new Socks5ProxyClient(ProxySettings.Host, ProxySettings.Port, ProxySettings.Username, ProxySettings.Password);

                _client = proxyClient.CreateConnection(_serverIp, _serverPort);
            }
            else
            {
                try
