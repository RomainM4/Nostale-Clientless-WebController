...
{
    public class DragonveilConfig : IConnectionConfig
    {
        ...
        private string _WorldIp { get; set; } = "79.110.84.175";
        ...
        public DragonveilConfig(ProxyType proxyType, string username, string password, string host, short port,
