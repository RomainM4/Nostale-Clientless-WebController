...
{
    public class JotunheimConfig : IConnectionConfig
    {
        ...
        private string _WorldIp { get; set; } = "79.110.84.89";
        ...
        public JotunheimConfig(ProxyType proxyType, string username, string password, string host, short port,
